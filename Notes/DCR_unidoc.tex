...
\title{Delayed Charge Recovery Tagging}
...
\begin{abstract}
A summary of delayed charge recovery (DCR) pulse-shape discrimination in the \MJ\ \DEM , which is used to identify alpha interaction background events that occur on the passivated surface of \ppc\ detectors. These problematic background events, which can be highly degraded in energy and therefore populate the \nonubb\ ROI, also exhibit distinctive pulse shapes due to slow charge collection. This unidoc describes the implementation, ongoing development, and systematic errors of the DCR discriminator. 
\end{abstract}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1.0\columnwidth]{figs/siggen_wf}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1.0\columnwidth]{figs/DCR_step1}
...
\begin{figure*}[t]
 \centering
 \includegraphics[width=1.0\textwidth]{figs/DCR_implementation}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1.0\columnwidth]{figs/DS2_DS3_cont_forUnidoc.pdf}
...
\begin{figure*}[t]
 \centering
 \includegraphics[width=1.0\textwidth]{figs/DS3_stab}
...
\begin{figure*}[t]
 \centering
 \includegraphics[width=1.0\textwidth]{figs/sample_eff_dcr90}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1.0\columnwidth]{figs/DCR_PS}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=1.0\columnwidth]{figs/ChargeTrappingStudy_trapENMCal.pdf}
...
\begin{figure*}[h]
 \centering
 \includegraphics[width=1.0\textwidth]{figs/ct_corr}
...
\begin{figure*}[h]
 \centering
 \includegraphics[width=.8\textwidth]{figs/TUBE_DCRPZ}
